...
import { APIPromise } from 'demo01/core/api-promise';

import util from 'node:util';
import Demo01 from 'demo01';
import { APIUserAbortError } from 'demo01';
  ...
  describe('logging', () => {
    ...
    test('warn when env var level is invalid', async () => {
      ...
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'DEMO01_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
